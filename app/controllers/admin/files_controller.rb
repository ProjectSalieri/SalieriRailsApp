class Admin::FilesController < ApplicationController
  ...
  # GET /admin/files/new_file
  def new_file
    @file_path = ""
    @content = ""
  end

  # POST /admin/files/twitter
  def create_file
  ...
  def update_file
    ...
    respond_to do |format|
      format.html { redirect_to index_file_admin_files_path }
    end
  end
  ...
  def delete_file
    ...
    respond_to do |format|
      format.html { redirect_to index_file_admin_files_path, :notice => "#{@file_path}を削除しました" }
    end
  end
